...
const VERSION_HISTORY = [
  ...
  { version: 'v4-monthly', date: '2024-04-01', description: '月次表示機能追加' },
  { version: 'v5-break', date: '2024-05-01', description: '休憩時間機能追加' },
  { version: 'v6-location', date: '2024-06-01', description: '勤務場所機能追加' },
...
function doOptions() {
  return Utils.createResponse({ ok: true, msg: 'CORS preflight OK', version: VERSION });
}
